...
class _NestedFirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout._fragment_nested_first, container, false)
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if (responseData != null) {
                    try {
                        ...
                        e.printStackTrace()
                        GlobalScope.launch(Dispatchers.Main) {
                            textView7.text = "Failed to parse JSON: ${e.message}" // Output exception message
                        }
                    }
                } else {
                    GlobalScope.launch(Dispatchers.Main) {
