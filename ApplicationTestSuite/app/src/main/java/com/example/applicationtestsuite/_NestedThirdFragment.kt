...
class _NestedThirdFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout._fragment_nested_third, container, false)
...
//    }
    ...
    private fun fetchAndDisplayData(_county: String, _town: String, datetime: String) {
        ...
        val updatedDateTime = originalDateTime.plusDays(2)
